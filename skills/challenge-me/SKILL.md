...
- Use `references/interview-question-bank.md`.
- Prioritize high-leverage unknowns first.
...
5) **Score strength**
- Score proposal using `references/scoring-rubric.md`.
- Include confidence and what would raise/lower the score.
...
- See `references/objection-policy.md`.
